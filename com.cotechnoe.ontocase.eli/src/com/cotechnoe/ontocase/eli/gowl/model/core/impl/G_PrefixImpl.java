...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GPrefix</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.cotechnoe.ontocase.eli.gowl.model.core.impl.G_PrefixImpl#getNs <em>Ns</em>}</li>
 *   <li>{@link com.cotechnoe.ontocase.eli.gowl.model.core.impl.G_PrefixImpl#getIri <em>Iri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class G_PrefixImpl extends MinimalEObjectImpl.Container implements G_Prefix {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.GPREFIX;
	}
	...
	public void setNs(String newNs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GPREFIX__NS, oldNs, ns));
	}
	...
	public void setIri(String newIri) {
		...
		iri = newIri;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GPREFIX__IRI, oldIri, iri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.GPREFIX__NS:
				return getNs();
			case CorePackage.GPREFIX__IRI:
				return getIri();
		}
