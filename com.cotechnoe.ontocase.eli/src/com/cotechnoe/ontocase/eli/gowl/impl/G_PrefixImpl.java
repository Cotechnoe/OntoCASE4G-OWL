 ...
 * </p>
 * <ul>
 *   <li>{@link com.cotechnoe.ontocase.eli.gowl.impl.G_PrefixImpl#getNs <em>Ns</em>}</li>
 *   <li>{@link com.cotechnoe.ontocase.eli.gowl.impl.G_PrefixImpl#getIri <em>Iri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class G_PrefixImpl extends MinimalEObjectImpl.Container implements G_Prefix {
	...
	protected EClass eStaticClass() {
		return GowlPackage.Literals.GPREFIX;
	}
	...
	public void setNs(String newNs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GowlPackage.GPREFIX__NS, oldNs, ns));
	}
	...
	public void setIri(String newIri) {
		...
		iri = newIri;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GowlPackage.GPREFIX__IRI, oldIri, iri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GowlPackage.GPREFIX__NS:
				return getNs();
			case GowlPackage.GPREFIX__IRI:
				return getIri();
		}
